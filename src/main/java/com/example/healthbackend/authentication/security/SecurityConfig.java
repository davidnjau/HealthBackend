package com.example.healthbackend.authentication.security;
...
import com.example.healthbackend.authentication.filter.JwtTokenAuthenticationFilter;
import com.example.healthbackend.authentication.filter.JwtTokenFilter;
import com.example.healthbackend.authentication.filter.JwtTokenStore;
import com.example.healthbackend.authentication.service_class.impl.StaffDetailsServiceImpl;
import com.example.healthbackend.webapp.helperclass.LoginResponse;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private void onAuthenticationSuccess(HttpServletRequest request,
        ...
        try {
            ...
            String fullNames = userDetails.getFullNames();

            LoginResponse loginResponse = new LoginResponse(
                    token, userId, fullNames, emailAddress,
